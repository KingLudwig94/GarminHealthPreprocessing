...
from garmin_health_processing.utils import retime
...
def toCsV(data):
    ...
    if(hr != None):
        ...
        hr = hr2
        hr = garmin_health_processing.hrv.HRV(hr).preprocess()
    hrsseries = Series(hr)
    ...
    if(step != None):
        ...
        step = step2
        step = garmin_health_processing.activity.Steps(step).preprocess()
    ...
    if(cal != None):
        ...
        cal = cal2
        cal = garmin_health_processing.activity.Calories(cal, 1, True, 1, 1).preprocess()
