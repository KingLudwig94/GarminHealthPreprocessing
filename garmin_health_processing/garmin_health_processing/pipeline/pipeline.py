...
"""
import garmin_health_processing
import json
...
def run_pipeline(data, showPlots: bool = False, savePlots: bool = False):
    ...
    if (st != None):
        ...
        st = st2
        out['steps'] = garmin_health_processing.activity.Steps(st, showPlots).run()
    ...
    if 'activity' in data:
        ...
        if (cal != None):
            ...
            out['calories'] = garmin_health_processing.activity.Calories(
    ...
    if (hr != None):
        ...
        if (data['heart_rate']['min_heart_rate'] != data['heart_rate']['max_heart_rate']):
            out['heartRate'] = garmin_health_processing.hrv.HRV(hr, showPlots, save=savePlots).run()
    ...
    if 'sleep' in data:
        if 'spo2' in data['sleep']:
            ...
            if (spo2 != None):
                ...
                spo2 = spo22
                out["spo2"] = (garmin_health_processing.spo2.SPO2(spo2, data['sleep']['duration'],
        ...
        if 'respiration' in data['sleep']:
            ...
            if (rsp != None):
                ...
                rsp = rsp2
                out['respiration'] = garmin_health_processing.respiration.RSP(
