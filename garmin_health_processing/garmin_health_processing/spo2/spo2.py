...
from garmin_health_processing.utils import fillNanIslands, findNanIsland, moving_average, retime, graph, showpreprocess
...
class SPO2:
    ...
    def preprocess(self) -> np.array:
        ...
        filled_spo2 = self.inputation(grid_spo2)
    ...
    @staticmethod
    def inputation(grid_spo2: dict) -> dict:
